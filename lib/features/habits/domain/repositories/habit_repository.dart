...
import '../entities/streak_recovery.dart';
...
abstract class HabitRepository {
  ...
  /// Use streak recovery to mark a missed day as completed.
  ...
  /// Get recent recovery records for a habit (within last 7 days).
  Future<Result<List<StreakRecovery>>> getRecentRecoveries({
    required String habitId,
    required String userId,
  });

  /// Check if recovery is available for a missed date.
