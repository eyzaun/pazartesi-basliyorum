...
class HabitRemoteDataSource {
  ...
  CollectionReference get _logsCollection => _firestore.collection('habit_logs');
  ...
  Future<void> deleteHabit(String habitId) async {
    try {
      ...
      final logsQuery = await _logsCollection
  ...
  Future<List<HabitLogModel>> getLogsForHabit(String habitId) async {
    try {
      ...
      return querySnapshot.docs
          .map((doc) => HabitLogModel.fromFirestore(doc.data() as Map<String, dynamic>))
          .toList();
    } catch (e) {
